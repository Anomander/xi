...
template <> struct Shared< SharedPolicy::kRc > : public RcCounter< Shared< SharedPolicy::kRc > > {
  auto self() { return intrusive_ptr< Shared< SharedPolicy::kRc > >(this); }
};
template <> struct Shared< SharedPolicy::kArc > : public ArcCounter< Shared< SharedPolicy::kArc > > {
...
template < class T > using EnableIfUnique = meta::enable_if< is_base_of< ownership::Unique, T > >;
...
template < class T, class... > struct Maker {
  template < class... Args > static auto make(Args&&... args) { return T{ ::std::forward< Args >(args)... }; }
};
template < class T > struct Maker< T, EnableIfShared< T, ownership::SharedPolicy::kStd > > {
  template < class... Args > static auto make(Args&&... args) {
    return make_shared< T >(::std::forward< Args >(args)...);
  }
};
template < class T > struct Maker< T, EnableIfShared< T, ownership::SharedPolicy::kRc > > {
  template < class... Args > static auto make(Args&&... args) {
    return intrusive_ptr< T >(new T(::std::forward< Args >(args)...));
  }
};
template < class T > struct Maker< T, EnableIfShared< T, ownership::SharedPolicy::kArc > > {
  template < class... Args > static auto make(Args&&... args) {
    return intrusive_ptr< T >(new T(::std::forward< Args >(args)...));
  }
};
template < class T > struct Maker< T, EnableIfUnique< T > > {
  template < class... Args > static auto make(Args&&... args) {
