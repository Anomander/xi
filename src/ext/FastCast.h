...
namespace xi {
  inline namespace ext {
           ...
           struct FastCastable <meta::vector <T,Ts...>>
             : FastCastableNode <T>
             , FastCastable <meta::vector <Ts...>>
           {};
           ...
           struct FastCastGroupMemberImpl <D, Group, meta::vector <T,Ts...>> : FastCastGroupMemberImpl <D, Group, meta::vector <Ts...>> {
           private:
             template <class Src>
             ...
             template <class Src>
               static auto _doCast(Src *, meta::FalseType) { return nullptr; }
           ...
           {
             static_assert (
                            meta::contains <typename Group::FastCastableGroupTypes, D> ::value
                            , "Declared type is not a member of the provided FastCastableGroup. See the definition of the "
