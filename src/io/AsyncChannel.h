...
public:
  ...
  virtual ~AsyncChannel() noexcept { detail::socket::close(descriptor()); }
  ...
  template < class Option > void setOption(Option option) {
...
template < AddressFamily af, SocketType sock, Protocol proto = kNone > class ChannelBase : public AsyncChannel {
public:
...
template < AddressFamily af, Protocol proto = kNone > class ClientChannel : public ChannelBase< af, kStream, proto > {
public:
...
template < AddressFamily af, Protocol proto = kNone > class ServerChannel : public ChannelBase< af, kStream, proto > {
public:
  using Endpoint_t = Endpoint< af >;
