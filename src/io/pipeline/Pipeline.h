...
private:
  template < class Event > void _fire(mut< UpstreamEvent >, Event&& e) { _head.fire(forward< Event >(e)); }
  template < class Event > void _fire(mut< DownstreamEvent >, Event&& e) { _tail.fire(forward< Event >(e)); }
